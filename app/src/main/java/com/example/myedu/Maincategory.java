...
public class Maincategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_category7);
        ...
        if (homeTextView != null) {
            homeTextView.setOnClickListener(view -> {
                Intent intent = new Intent(Maincategory.this, MainActivity4Home.class);
        ...
        if (leaderboardTextView != null) {
            leaderboardTextView.setOnClickListener(view -> {
                Intent intent = new Intent(Maincategory.this, leaderboard.class);
                startActivity(intent);
            });
        }
        ...
        if (profileTextView != null) {
            profileTextView.setOnClickListener(view -> {
                Intent intent = new Intent(Maincategory.this, profile.class);
                startActivity(intent);
            });
        }
    }
