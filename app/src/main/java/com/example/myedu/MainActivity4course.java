...
public class MainActivity4course extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_main_activity5course);
        ...
        if (homeTextView != null) {
            homeTextView.setOnClickListener(view -> {
                Intent intent = new Intent(MainActivity4course.this, MainActivity4Home.class);
        ...
        if (leaderboardTextView != null) {
            leaderboardTextView.setOnClickListener(view -> {
                Intent intent = new Intent(MainActivity4course.this, leaderboard.class);
                startActivity(intent);
            });
        }
        ...
        if (profileTextView != null) {
            profileTextView.setOnClickListener(view -> {
                Intent intent = new Intent(MainActivity4course.this, profile.class);
                startActivity(intent);
            });
        }
    }
